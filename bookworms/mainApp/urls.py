...
urlpatterns = [
    ...
    path(
        'notifications/<int:message_id>/open/',
        notification_open_chat,
        name='notification_open_chat',
    ),
    path(
        'notifications/<int:message_id>/confirm-return/',
        notification_confirm_return,
        name='notification_confirm_return',
    ),
