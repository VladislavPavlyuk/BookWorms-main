...
urlpatterns = [
    ...
    path("copies/<int:copy_id>/queue/", views.copy_queue_list),
    path("copies/<int:copy_id>/queue/join/", views.copy_queue_join),
    path("copies/<int:copy_id>/queue/leave/", views.copy_queue_leave),
    path("queue/mine/", views.my_queues),
    ...
    path("handoffs/<int:handoff_id>/give/", views.handoff_confirm_give),
    path("handoffs/<int:handoff_id>/receive/", views.handoff_confirm_receive),
    path("handoffs/<int:handoff_id>/cancel/", views.handoff_cancel),
